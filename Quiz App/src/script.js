...
const generateQuiz = async(difficulty,topic) => {
    try {
      ...
      var prompt = "(Use wikipedia for reference) (questions must be different from previous prompt) generate 10 different quiz questions in multiple choice format about storyline, plot, dialogues, cast, characters of {"

      prompt += topic;
      prompt += "}. a question must be no more than 15-25 words of difficulty "
